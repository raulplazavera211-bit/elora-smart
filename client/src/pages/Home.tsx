                ...
                <div className="grid grid-cols-1 md:grid-cols-12 md:grid-rows-2 gap-3 md:gap-4 px-6 pb-8 md:px-12 md:pb-10" style={{gridTemplateRows: 'repeat(2, 240px)' as any}}>
                  ...
                  >
                    <img
                      ...
                      className="absolute inset-0 w-full h-full object-cover transition-transform duration-[2.5s] ease-out group-hover:scale-105 opacity-90" style={{objectPosition: '0% 30%'}}
                    />
