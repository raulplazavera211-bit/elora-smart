...
const AURA_SUSP_GALLERY = [
  "/product-assets/IMG_7179.jpeg",
  "/product-assets/IMG_7180.jpeg",
  "/product-assets/IMG_7181.jpeg",
  "/product-assets/IMG_7182.jpeg",
  "/product-assets/IMG_7183.jpeg",
  "/product-assets/IMG_7184.jpeg",
  "/product-assets/IMG_7185.jpeg",
  "/product-assets/IMG_7186.jpeg",
  "/product-assets/IMG_7187.jpeg",
  "/product-assets/IMG_7188.jpeg",
];
...
const AURA_GALLERY = [
  "/product-assets/AURA%20suelo%20descarga.png",
  "/product-assets/AURA%20suelo%20tanque%20integrado.png",
  "/product-assets/IMG_7203.jpeg",
  "/product-assets/IMG_7205.jpeg",
  "/product-assets/IMG_7206.jpeg",
  "/product-assets/IMG_7207.jpeg",
  "/product-assets/IMG_7208.jpeg",
  "/product-assets/IMG_7209.jpeg",
  "/product-assets/IMG_7210.jpeg",
  "/product-assets/IMG_7211.jpeg",
];
...
const EXPERIENCE_STEPS = [
  ...
  { number: "04", eyebrow: "Higiene completa con agua", title: "Lavado posterior, femenino y móvil", subtitle: "temperatura y presión ajustables", body: "Agua caliente instantánea. Boquilla autolimpiable en acero inoxidable. Tres modos de lavado personalizables. La higiene que el papel nunca puede dar.", image: "/manus-storage/experience-step4-lavado_a93c706c.png", tag: "Sistema de lavado triple" },
  ...
  { number: "08", eyebrow: "Control total", title: "Mando a distancia", subtitle: "para guardar tus preferencias", body: "Mando en español con memoria para 2 usuarios. Guarda tus ajustes de temperatura, modos de lavado y secado. Todo personalizado, siempre listo.", image: "/manus-storage/experience-step8-mando_41c0f2ee.png", tag: "2 perfiles de usuario" },
];
    ...
    if (productsQuery.data && productsQuery.data.length > 0) {
      ...
      const merged = localizedBase.map((fallback) => {
        ...
        return {
          ...
          gallery: fallback.id === "ESENZA" || fallback.id === "AURA" || fallback.id === "AURA-COMPACT" || fallback.id === "AURA-SUSPENDIDO" || hasUnmigratedProductPath
            ? fallback.gallery
                  ...
                  <div className="md:col-span-8 grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
                    ...
                    >
                      ...
                      <div className="relative overflow-hidden bg-muted min-h-[220px] md:min-h-[180px]">
                        <img
                          src="/manus-storage/aura-suspendido-v3_9a4f47aa.png"
                          alt="AURA Suspendido"
