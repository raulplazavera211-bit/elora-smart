...
const HERO_IMAGE = "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/RMKyQXoRPdthSwmk.jpg";

const PRODUCT_IMAGES: Record<string, string> = {
  "ESENZA": "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/RMKyQXoRPdthSwmk.jpg",
  "AURA-COMPACT": "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/EqfynglXTJmMnxhp.webp",
  "AURA-SUSPENDIDO": "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/QKUHxLrIzEHuKuPQ.jpg",
};
// SECTIONS se genera dinámicamente con i18n dentro del componente

const ESENZA_GALLERY = [
  "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/RMKyQXoRPdthSwmk.jpg",
  "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/LWPvSCysNGEooYvZ.webp",
  "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/KUcoVmdTnUpBQtjo.webp",
  "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/YXMZHraONuzXWVsm.webp",
  "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/ZjmyxZLgokGhYaag.webp",
  "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/UyisaLOXlyPuXSAf.webp",
  "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/ZXdMiOYHWWVmaEgO.webp",
  "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/znASBLEIGIRgRJKP.webp",
];

const AURA_COMPACT_GALLERY = [
  "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/YVjEbHnGLPJxnAFa.jpg",
  "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/fFLXTHFJUqHHZCkX.jpg",
  "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/JDhEtXRKXgJCuuEL.jpg",
  "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/alLSTgTXfFJZbzvX.jpg",
  "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/BuCRLiGIXoHqxnXr.jpg",
  "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/NnmoXqphJsnZxfSM.jpg",
  "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/DFpvKdGQHpEzSwmY.jpg",
];

const AURA_SUSP_GALLERY = [
  "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/QKUHxLrIzEHuKuPQ.jpg",
  "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/oZJdUhMapLRRAGAY.jpg",
  "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/ARAxyHakIjUJfxdW.jpg",
  "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/LtArLEWWFOBAccmD.jpg",
  "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/JvbeYeMwXfpCcYoA.jpg",
  "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/dAldGgvFMJBTGUiJ.jpg",
  "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/lkaKJbMFKbOQJLSp.jpg",
];
...
const PRODUCTS: Product[] = [
  {
    ...
    img: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/RMKyQXoRPdthSwmk.jpg",
  ...
  },
  {
    ...
    img: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/EqfynglXTJmMnxhp.webp",
  ...
  },
  {
    ...
    img: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/QKUHxLrIzEHuKuPQ.jpg",
...
const ESENZA_COMPACT_GALLERY = [
  "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/dZEMrUEILPTorKCX.webp",
  "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/BoeuLDQlvoYpmNXU.webp",
  "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/JJlbpMQOFLlfjjyOY.webp",
  "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/ADgRKwKhLWUYpWcc.webp",
  "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/ZUvcdHjfcUxwCkgR.webp",
  "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/ZkDBYTGAOwhbxCsL.webp",
  "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/igvPxXuqaNgcRnRB.webp",
  "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/IbwoiqbiyduoJNHD.webp",
  "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/rxDzrGDjOtozlnob.webp",
];

const ESENZA_SUSP_GALLERY = [
  "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/lczMtvLWDtoFpypL.webp",
  "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/zRXpHHukfqFgdzrv.webp",
  "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/lhhbnUZrBipbjPUR.webp",
  "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/fWfFOwJfsZrQZdlg.webp",
  "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/LkpaJxznLkRVBQzm.webp",
  "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/XVWUqbbNSqLQnFci.webp",
];

const AURA_GALLERY = [
  "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/SxTCAYieVNhNQzwf.jpg",
  "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/HhXOZkntNfjCmInL.jpg",
  "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/yuxzooTroPqYjDiK.jpg",
  "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/WBOSPlFuDKxfNHsV.jpg",
  "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/bxqKvJzpGgzTYnnt.jpg",
  "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/KWehtPRIuufKjRuI.jpg",
  "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/OXbyTJgLaKMMHvGq.jpg",
  "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/HMBEFwRNFiJqHrjL.jpg",
  "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/NqvXbEwPfPJJqfJc.jpg",
  "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/OfHfkXaFQkFMqGJg.jpg",
];
...
const EXTRA_PRODUCTS: Product[] = [
  {
    ...
    img: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/dZEMrUEILPTorKCX.webp",
  ...
  },
  {
    ...
    img: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/lczMtvLWDtoFpypL.webp",
  ...
  },
  {
    ...
    img: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/SxTCAYieVNhNQzwf.jpg",
...
function ClubEloraSection() {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 opacity-[0.04]" style={{ backgroundImage: "url('https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/SxTCAYieVNhNQzwf.jpg')", backgroundSize: "cover", backgroundPosition: "center", filter: "grayscale(100%)" }} />
...
function EsenciaVideoCard() {
  ...
  return (
    ...
    >
      <video
        ref={videoRef}
        src="https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/ArngzdYlSloIcCbX.mp4"
        playsInline
        muted
        loop
            ...
            <>
              ...
              >
                ...
                <div className="absolute inset-0 w-full h-full overflow-hidden pointer-events-none">
                  ...
                  >
                    <source src="https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/JUlDWBzjoebLBhDk.mp4" type="video/mp4" />
                  </video>
                </div>
              ...
              >
                ...
                <div id="esencia-grid" className="grid grid-cols-1 md:grid-cols-12 md:grid-rows-2 gap-3 md:gap-4 px-6 pb-8 md:px-12 md:pb-10">
                  ...
                  >
                    <img
                      src="https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/QbtCGEKMrBpZPZYn.webp"
                  ...
                  <div className="md:col-span-8 grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
                    ...
                    >
                      ...
                      <div className="relative overflow-hidden bg-muted min-h-[220px] md:min-h-[180px]">
                        <img
                          src="https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/QKUHxLrIzEHuKuPQ.jpg"
                          alt="AURA Suspendido"
                    ...
                    <div className="mt-5 relative w-full" style={{ height: '200px' }}>
                      ...
                      <MapView
                        ...
                        onMapReady={(map) => {
                          ...
                          img.src = "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/WejihdAdoNhfTwYK.png";
