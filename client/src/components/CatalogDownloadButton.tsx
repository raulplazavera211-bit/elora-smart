...
const CATALOG_LANGS = [
  { code: "es", label: "Español",    flag: "🇪🇸", url: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/UFxHJyKBMxsxdLMM.pdf",  filename: "Catálogo-ELORA-2026-ES.pdf" },
  { code: "en", label: "English",    flag: "🇬🇧", url: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/lLhXrCXkRrriRIQC.pdf",  filename: "Catalogue-ELORA-2026-EN.pdf" },
  { code: "fr", label: "Français",   flag: "🇫🇷", url: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/QsQMfxvpoXJyJWEY.pdf",  filename: "Catalogue-ELORA-2026-FR.pdf" },
  { code: "pt", label: "Português",  flag: "🇵🇹", url: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/CWVXDtlMseoVwfLF.pdf",  filename: "Catálogo-ELORA-2026-PT.pdf" },
];
