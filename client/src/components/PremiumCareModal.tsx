      ...
      {isOpen && (
        <>
          ...
          <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 overflow-y-auto">
            ...
            >
              {/* Header dorado */}
              <div className="relative bg-gradient-to-br from-[#c9a227] via-[#e8c547] to-[#b8891a] px-5 pt-5 pb-7 overflow-hidden">
                {/* Patrón decorativo */}
                ...
                {/* Precio destacado */}
                <div className="relative z-10 mt-3 inline-flex items-baseline gap-1.5 bg-black/15 px-3 py-1.5">
              ...
              <div className="px-5 py-4">
                ...
                <div className="grid grid-cols-2 gap-2">
                  {PREMIUM_BENEFITS.map(({ icon: Icon, label, sub }) => (
                    <div key={label} className="flex items-start gap-2.5 p-3 bg-muted border border-border">
                      ...
                      <div>
                        <p className="font-body text-[11px] font-semibold text-foreground leading-tight">{label}</p>
                        <p className="font-body text-[9px] text-foreground/50 leading-tight mt-0.5">{sub}</p>
                      </div>
                    </div>
                  ))}
                </div>
              ...
              <div className="px-5 pb-5 flex flex-col gap-2.5">
                <button
                  onClick={onAccept}
                  className="w-full flex items-center justify-center gap-2.5 bg-[#c9a227] text-black font-body text-[11px] uppercase tracking-[0.3em] py-4 hover:bg-[#b8891a] transition-colors active:scale-[0.98]"
                >
