...
const HERO_VIDEO = "https://files.manuscdn.com/user_upload_by_module/session_file/310519663455453024/uHpvWeuDOfHpoeFR.mp4";
  ...
  if (isAdmin) {
    return (
      <Switch>
        ...
        <Route path="/admin/popups" component={AdminPopups} />
        <Route path="/admin/experiencia" component={AdminExperiencia} />
